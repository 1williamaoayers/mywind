...
> 来源: https://akshare.akfamily.xyz/akdocker/akdocker.html
> 抓取时间: 2026-01-06T00:59:36.773Z

---

# [AKShare](https://github.com/akfamily/akshare) Docker 部署[](#akshare-docker "Link to this heading")
...
## 安装 Docker[](#docker "Link to this heading")

### 官方安装指导[](#id1 "Link to this heading")
...
### 第三方安装指导[](#id2 "Link to this heading")
...
### 配置国内镜像[](#id3 "Link to this heading")
...
## AKDocker 镜像使用[](#akdocker "Link to this heading")

### 拉取 AKDocker 镜像[](#id4 "Link to this heading")

此镜像会在每次 AKShare 更新版本时自动更新

docker pull registry.cn\-shanghai.aliyuncs.com/akfamily/aktools:jupyter

### 运行 AKDocker 容器[](#id5 "Link to this heading")

docker run \-it registry.cn\-shanghai.aliyuncs.com/akfamily/aktools:jupyter

### 测试 AKDocker 容器[](#id6 "Link to this heading")

import akshare as ak

print(ak.\_\_version\_\_)

## 使用案例[](#id7 "Link to this heading")

### 背景说明[](#id8 "Link to this heading")
...
### 注意事项[](#id10 "Link to this heading")
