...
> 来源: https://akshare.akfamily.xyz/anaconda.html
> 抓取时间: 2026-01-06T00:59:19.549Z

---

# [AKShare](https://github.com/akfamily/akshare) 环境配置[](#akshare "Link to this heading")

## Anaconda 安装说明[](#anaconda "Link to this heading")
...
## Anaconda 安装演示[](#id1 "Link to this heading")
...
conda create \-n ak\_test python\=3.8.5
...
激活已经创建好的 ak\_test 虚拟环境

conda activate ak\_test

在 ak\_test 虚拟环境中安装并更新 [AKShare](https://github.com/akfamily/akshare)
...
在 ak\_test 虚拟环境的 Python 环境里面输入:
...
还可以在 ak\_test 虚拟环境的 Python 环境中输入如下代码可以显示 [AKShare](https://github.com/akfamily/akshare) 的版本信息
