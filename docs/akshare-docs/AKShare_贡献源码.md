...
> 来源: https://akshare.akfamily.xyz/contributing.html
> 抓取时间: 2026-01-06T00:59:30.638Z

---

# [AKShare](https://github.com/akfamily/akshare) 贡献源码[](#akshare "Link to this heading")

## 贡献指南[](#id1 "Link to this heading")

### 克隆及提交代码[](#id2 "Link to this heading")
...
### 代码及接口设计规范[](#id3 "Link to this heading")
...
3.  函数接口的设计 **stock\_zh\_a\_hist\_sina** 结构，其中 **stock** 为金融产品，**zh** 为国家或地区，**a** 为市场或品种，**hist** 为 history 的缩写表示历史数据，**sina** 表示数据源为新浪
    
4.  接口函数需要增加注释，注释规则请参考 **stock\_zh\_a\_hist\_sina** 接口的源码
...
### 文档撰写规范[](#id4 "Link to this heading")
...
3.  以股票分时数据接口文档为例：
    ...
    2.  示例如下：
      ...
      | ma\_volume5    | float64      |  \-     |
      | ma\_price10    | float64      |  \-     |
      | ma\_volume10   | float64      |  \-     |
      | ma\_price30    | float64      |  \-     |
      | ma\_volume30   | float64      |  \-     |
      \\\`\`\`
      ...
      stock\_zh\_a\_minute\_df \= ak.stock\_zh\_a\_minute(symbol\='sz000876', period\='1', adjust\="qfq")
      print(stock\_zh\_a\_minute\_df)
      \\\`\`\`
