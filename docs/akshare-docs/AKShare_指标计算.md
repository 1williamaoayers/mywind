...
> 来源: https://akshare.akfamily.xyz/indicator.html
> 抓取时间: 2026-01-06T00:59:02.137Z

---

# [AKShare](https://github.com/akfamily/akshare) 指标计算[](#akshare "Link to this heading")

## 已实现波动率指标[](#id1 "Link to this heading")

### YZ 已实现波动率[](#yz "Link to this heading")

接口: volatility\_yz\_rv
...
包含日期和 OHLC(开高低收) 价格的 pandas.DataFrame
...
stock\_df \= ak.rv\_from\_stock\_zh\_a\_hist\_min\_em(
    symbol\="000001",
    start\_date\="2021-10-20 09:30:00",
    end\_date\="2024-11-01 15:00:00",
    period\="5",
    adjust\=""
)
volatility\_yz\_rv\_df \= ak.volatility\_yz\_rv(data\=stock\_df)
print(volatility\_yz\_rv\_df)
