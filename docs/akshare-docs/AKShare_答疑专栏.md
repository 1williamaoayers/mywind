...
> 来源: https://akshare.akfamily.xyz/answer.html
> 抓取时间: 2026-01-06T00:59:09.486Z

---

# [AKShare](https://github.com/akfamily/akshare) 答疑专栏[](#akshare "Link to this heading")

## 专栏介绍[](#id1 "Link to this heading")

本专栏的主要目的是为了解决在使用 [AKShare](https://github.com/akfamily/akshare) 中遇到的各种问题，主题包括但不限于：环境配置、AKShare 安装和升级、数据接口请求、代理配置等等。

## 常见问题[](#id2 "Link to this heading")
...
\# 列名与数据对其显示
pd.set\_option('display.unicode.ambiguous\_as\_wide', True)
pd.set\_option('display.unicode.east\_asian\_width', True)
\# 显示所有列
pd.set\_option('display.max\_columns', None)
\# 显示所有行
pd.set\_option('display.max\_rows', None)

stock\_zh\_index\_daily\_df \= ak.stock\_zh\_index\_daily(symbol\="sz399552")
print(stock\_zh\_index\_daily\_df)
